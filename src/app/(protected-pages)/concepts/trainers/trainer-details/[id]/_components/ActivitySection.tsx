...
import { apiGetTrainerLog } from '@/services/TrainersService'
...
const ActivitySection = ({
    ...
    const { data, isLoading } = useSWR(
        ['/api/trainers/log', { id: id as string }],
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ([_, params]) => apiGetTrainerLog<Activities, { id: string }>(params),
        {
                    ...
                    <div key={log.id} className="mb-4">
                        ...
                        <div className="flex flex-col gap-4">
                            {isEmpty(log.events) ? (
                                ...
                                log.events.map((event: any, index: any) => (
                                    <div
