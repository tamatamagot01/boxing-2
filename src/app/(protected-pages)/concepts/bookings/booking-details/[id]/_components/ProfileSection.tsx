...
import { TrainerDetailsProps } from './BookingDetails'
        ...
        <Card className="w-full">
            ...
            <div className="flex flex-col xl:justify-between h-full 2xl:min-w-[360px] mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-y-7 gap-x-4 mt-10">
                    <BookingInfoField title="Email" value={data.email} />
                    <BookingInfoField title="Phone" value={data.phone} />
                </div>
                ...
                >
                    <p>
                        Are you sure you want to delete this booking? All record
                        related to this booking will be deleted as well. This
