    ...
    return (
        <div className="px-6 max-w-lg mx-auto">
            ...
            <div className="mb-4">
                ...
                <div className="text-sm text-red-500 font-medium mt-4 bg-red-50 dark:bg-red-900/20 p-3 rounded-lg border border-red-100 dark:border-red-800">
                    Please honor your booking. No-shows prevent others from joining the class.
                </div>
            </div>
        </div>
    )
